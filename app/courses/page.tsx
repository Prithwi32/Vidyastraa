...
export default function Courses() {
        ...
        handler: async function (response: any) {
          try {
            ...
            if (verifyData.isOk) {
              ...
              // 1️⃣ Get userId (if using authentication)
              const userId = "user_id_from_auth"; // Replace with actual user ID from auth context/session
  
              // 2️⃣ Call API to store payment and enroll user
  ...
  return (
    <div className="container py-12">
      ...
      <ToastContainer />
      <h2 className="text-3xl font-bold text-center mb-8 text-purple-800">Our Courses</h2>
