...
export async function GET(
  ...
  try {
    ...
    page.drawText(`Category: ${test.category}`, {
      x: 50,
      y,
      font,
      size: fontSize,
    ...
    page.drawText(`Created On: ${createdDate}`, {
      x: 50,
      y,
      font,
      size: fontSize,
    ...
    // Questions
    page.drawText(`Questions involved in test are:`, {
      x: 50,
      y,
      font,
      size: fontSize,
    ...
    for (const [index, q] of test.questions.entries()) {
      ...
      page.drawText(`${index + 1}. ${question.question}`, {
        x: 50,
        y,
        font,
        size: fontSize,
