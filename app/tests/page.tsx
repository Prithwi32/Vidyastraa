...
export default function ExamInterface() {
  ...
  const [currentQuestionIndex, setCurrentQuestionIndex] = useState(15) // 0-based index, so 15 is question 16
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    ...
    for (let i = 1; i <= 30; i++) {
      sampleQuestions.push({
        ...
        status: i === 16 ? "current" : i === 25 ? "review" : i === 1 ? "attempted" : "unattempted",
        selectedOption: i === 1 ? "A" : undefined,
      })
    }
  ...
  const formattedTime = `${time.hours.toString().padStart(2, "0")}h:${time.minutes.toString().padStart(2, "0")}m:${time.seconds.toString().padStart(2, "0")}s`
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50">
      {/* Header */}
      <header className="sticky top-0 z-30 flex items-center justify-between p-4 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Misc Paper 1</p>
          </div>
        </div>
        ...
        <div className="flex-1 p-4 md:p-6 overflow-y-auto">
          <div className="max-w-4xl mx-auto">
            <Card className="border-slate-700 dark:border-slate-700 shadow-sm bg-white dark:bg-slate-900">
              <CardHeader className="pb-3 flex flex-row items-center justify-between bg-slate-50 dark:bg-slate-800 rounded-t-lg">
                <div>
                  <Badge
                    variant="outline"
              ...
              <CardContent className="pt-4 dark:bg-slate-900">
                ...
                <div className="mt-6 text-sm text-slate-500 dark:text-slate-400">
                  <span className="font-medium text-slate-600 dark:text-slate-300">{`>`} Solution</span>
                </div>
              </CardContent>

              <CardFooter className="flex justify-between pt-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 rounded-b-lg">
                <Button
                  variant="outline"
...
function QuestionNavigationPanel({
  ...
  return (
    <div className="p-4 h-full overflow-y-auto bg-white dark:bg-slate-900">
